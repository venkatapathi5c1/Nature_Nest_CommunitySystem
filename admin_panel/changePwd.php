...
if(isset($_POST['submit']))
{
  ...
  $query=mysqli_query($conn,"select * from admin where id='$admin_id' and  password='$cpassword'");
  $row=mysqli_fetch_array($query);

  if($row>0){
        $ret=mysqli_query($conn,"update admin set password='$newpassword' where id='$admin_id'");
