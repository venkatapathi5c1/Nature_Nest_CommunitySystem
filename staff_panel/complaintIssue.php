                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                                ...
                                INNER JOIN users ON users.id = complaint_issues.tenant_id WHERE ctype = '$staff_id'";
                            ...
                            <tr>
                                ...
                                <?php if($rows['IssueStatus'] == 0){ ?>
                                    ...
                                    <?php } ?>
                                <td>  
                                    <a class="btn btn-danger" href="complaintIssue.php?delId=<?php echo $rows['CID']; ?>" onclick="return confirm('Are sure to want delete this Record!');" style="font-size:12px"><i class="fas fa-trash-alt"></i> Delete</a>
